...
| **TaxonRouter**<br/>([GitHub](https://github.com/LOUST-PRO/TaxonRouter)) | Dual-binary GitHub Projects triage automation in Go: MCP stdio server + webhook auto-tagger. | Automated PR slicing, batch label reconciliation, and zero-dependency webhook ingestion. |
