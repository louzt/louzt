...
| --- | --- | --- |
| PipeWire / Freedesktop (handshake timeout in `module-protocol-native`), NGINX Core (CRLF sanitization via `r->pool`), Bottles (Manager lifecycle isolation), Waypaper (#278-#286), linux-wallpaperengine (#574, #576), Chromium 148 CSP (Opera GB-80414) | Cross-runtime reliability: PipeWire C daemon timers, NGINX `r->pool` allocator isolation, GTK subprocess lifecycle, `wlr-layer-shell` contracts, and CSP L3 isolation. | **OSS hardening upstream** |
| 50K embeddings queried in 188 ms across GPU-backed retrieval pipelines. MCP surfaces shipped as JSON-RPC stdio servers for agent tooling (image / TTS / video / web search) | Local-first retrieval substrate with O(1) compaction, FNV-1a 64-bit signed-hash projection, and zero telemetry egress. | **AI / RAG systems** |
| 15–20% throughput lift in NetBoozt benchmarks. Bare-metal Linux VPS hardening: `sshd` locks, multi-tenant boundary, automated state snapshots, and 5-tier QUIC/SSH fallback proxy | End-to-end substrate control and security posture managed under a single unified operator audit trail. | **Network & infrastructure** |
| Scoped PRs, deterministic tooling, audit-first workflows, and verifiable provenance chains over commit volume | Upstream extraction executed only when runtime contracts and abstraction boundaries are clean and readable. | **Release hygiene** |
...
| Go + Rust proxy racing QUIC / Hysteria2 / direct TLS / SSH to evade DPI and TCP Cubic collapse under 5% packet loss. Public gists: [5-tier evasion chain (v1.0)](https://gist.github.com/louzt/3991f144c7d67726045af3cefc60f42a) + [5-layer fallback SSH chain](https://gist.github.com/louzt/e318d7e0ae1fd676d124311c80585f74) | Sub-200ms first-healthy-stream promotion sidesteps Linux TCP retransmits; CA-pinning blocks MITM and POSIX-atomic writes eliminate storage state drift.<br/><br/><a href="#"><img src="https://img.shields.io/badge/Go-00ADD8?style=flat-square&logo=go&logoColor=white" alt="Go"/></a> <a href="#"><img src="https://img.shields.io/badge/Rust-000000?style=flat-square&logo=rust&logoColor=white" alt="Rust"/></a> <a href="#"><img src="https://img.shields.io/badge/QUIC-0093D0?style=flat-square" alt="QUIC"/></a> <a href="#"><img src="https://img.shields.io/badge/Hysteria2-1F2937?style=flat-square" alt="Hysteria2"/></a> <a href="#"><img src="https://img.shields.io/badge/TLS-2C3E50?style=flat-square" alt="TLS"/></a> <a href="#"><img src="https://img.shields.io/badge/SSH-000000?style=flat-square" alt="SSH"/></a> | **5-tier multi-protocol transport proxy** (private) |
| 3D fighting game engine with rollback netcode, WebSocket relay upgrading to WebRTC DataChannel, and optional TURN/COTURN auth. Babylon.js 8, Bun + Vite + TypeScript strict | High-concurrency matches survive restrictive NATs and DPI; deterministic frame rollback preserves input resolution across independent clocks.<br/><br/><a href="#"><img src="https://img.shields.io/badge/Bun-000000?style=flat-square&logo=bun&logoColor=white" alt="Bun"/></a> <a href="#"><img src="https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white" alt="TypeScript"/></a> <a href="#"><img src="https://img.shields.io/badge/Vite-646CFF?style=flat-square&logo=vite&logoColor=white" alt="Vite"/></a> <a href="#"><img src="https://img.shields.io/badge/Babylon.js_8-000000?style=flat-square&logo=babylondotjs&logoColor=white" alt="Babylon.js 8"/></a> <a href="#"><img src="https://img.shields.io/badge/WebSocket-2C3E50?style=flat-square" alt="WebSocket"/></a> <a href="#"><img src="https://img.shields.io/badge/WebRTC-333333?style=flat-square&logo=webrtc&logoColor=white" alt="WebRTC"/></a> <a href="#"><img src="https://img.shields.io/badge/TURN%2FCOTURN-7C3AED?style=flat-square" alt="TURN/COTURN"/></a> | **h4kken** (private, deployed at h4kken.loust.pro) |
| Multi-tenant B2B engine: CRMs, ERP flows, booking engines, ad ingestion (Meta/Google Ads → Postgres), and multi-tier VPS isolation | Proven 7+ year operational stability without resetting the substrate; tenant-isolated Postgres/Redis namespaces eliminate cross-tenant noise.<br/><br/><a href="#"><img src="https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white" alt="PostgreSQL"/></a> <a href="#"><img src="https://img.shields.io/badge/Redis-DC382D?style=flat-square&logo=redis&logoColor=white" alt="Redis"/></a> <a href="#"><img src="https://img.shields.io/badge/Prisma-3982CE?style=flat-square&logo=prisma&logoColor=white" alt="Prisma"/></a> <a href="#"><img src="https://img.shields.io/badge/GraphQL-E10098?style=flat-square&logo=graphql&logoColor=white" alt="GraphQL"/></a> <a href="#"><img src="https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=nextdotjs&logoColor=white" alt="Next.js"/></a> <a href="#"><img src="https://img.shields.io/badge/Astro-BC52EE?style=flat-square&logo=astro&logoColor=white" alt="Astro"/></a> <a href="#"><img src="https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white" alt="TypeScript"/></a> | **LOUST multi-tenant platform** (current, 7y6m) |
...
| Identity-based QUIC transport toolkit with Ed25519-signed tickets, server-side subject binding, and self-hosted relay scaffolding | QUIC connection migration with subject-pinned ticket rotation maintains active control planes across NAT rebinds with zero vendor crypto.<br/><br/><a href="#"><img src="https://img.shields.io/badge/Rust-000000?style=flat-square&logo=rust&logoColor=white" alt="Rust"/></a> <a href="#"><img src="https://img.shields.io/badge/QUIC-0093D0?style=flat-square" alt="QUIC"/></a> <a href="#"><img src="https://img.shields.io/badge/Ed25519-2C3E50?style=flat-square" alt="Ed25519"/></a> | [SnapPipe](https://github.com/LOUST-PRO/SnapPipe) |
| Linux network tuning suite: BBR TCP congestion optimization, intelligent failover, and DNS cache protection | Unlocks 15–20% throughput gains directly from Linux kernel defaults (queueing, congestion control, socket buffers) without extra bandwidth cost.<br/><br/><a href="#"><img src="https://img.shields.io/badge/Linux-FCC624?style=flat-square&logo=linux&logoColor=black" alt="Linux"/></a> <a href="#"><img src="https://img.shields.io/badge/BBR-4285F4?style=flat-square" alt="BBR"/></a> <a href="#"><img src="https://img.shields.io/badge/TCP--BBR-2C3E50?style=flat-square" alt="TCP/BBR"/></a> <a href="#"><img src="https://img.shields.io/badge/DNS-1F2937?style=flat-square" alt="DNS"/></a> | [NetBoozt](https://github.com/LOUST-PRO/NetBoozt_InternetUpgrade) |
| Dual-binary GitHub automation: MCP server + webhook auto-tagger. Pulls metadata via JSON-RPC stdio surface and manages GitHub Projects triage | Single-binary infrastructure for automated PR slicing, F80.9 batching, and label reconciliation with zero outbound dependencies.<br/><br/><a href="#"><img src="https://img.shields.io/badge/Go-00ADD8?style=flat-square&logo=go&logoColor=white" alt="Go"/></a> <a href="#"><img src="https://img.shields.io/badge/MCP-7C3AED?style=flat-square" alt="MCP"/></a> <a href="#"><img src="https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white" alt="GitHub"/></a> | [TaxonRouter](https://github.com/LOUST-PRO/TaxonRouter) |
| Public artefact: [LOUST-PRO/syprememx](https://github.com/LOUST-PRO/syprememx) — multi-tenant brand platform (CRM, ERP flows, booking, e-commerce, Astro + Next.js + Prisma + GraphQL). CTO of operating entity SYPREME | 42 Prisma models and 600+ GraphQL endpoints running e-commerce, operations, and marketing on one unified codebase. Sub-2-minute lead-to-quote latency under peak exhibition traffic.<br/><br/><a href="#"><img src="https://img.shields.io/badge/Astro-BC52EE?style=flat-square&logo=astro&logoColor=white" alt="Astro"/></a> <a href="#"><img src="https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=nextdotjs&logoColor=white" alt="Next.js"/></a> <a href="#"><img src="https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white" alt="TypeScript"/></a> <a href="#"><img src="https://img.shields.io/badge/Prisma-3982CE?style=flat-square&logo=prisma&logoColor=white" alt="Prisma"/></a> <a href="#"><img src="https://img.shields.io/badge/GraphQL-E10098?style=flat-square&logo=graphql&logoColor=white" alt="GraphQL"/></a> <a href="#"><img src="https://img.shields.io/badge/Stripe-635BFF?style=flat-square&logo=stripe&logoColor=white" alt="Stripe"/></a> <a href="#"><img src="https://img.shields.io/badge/CFDI_4.0-2C3E50?style=flat-square" alt="CFDI 4.0"/></a> | **SypremeMX + SYPREME Sybarite Premium Meats** (public repo + 6y7m, concurrent) |
...
| Recording and headless rendering pipeline for OSS demonstrations, benchmarking, and documentation automation | Shared execution seam guarantees reproducible visual artifacts and performance metrics across workstation and CI pipelines.<br/><br/><a href="#"><img src="https://img.shields.io/badge/Headless_Renderer-2C3E50?style=flat-square" alt="Headless Renderer"/></a> <a href="#"><img src="https://img.shields.io/badge/Screenshot_Repro-8B5CF6?style=flat-square" alt="Screenshot Repro"/></a> | **Built-in signal pipeline** (drafting) |
