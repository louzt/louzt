...
<table width="100%">
  <tr>
    ...
    <td align="left" valign="middle">
      ...
      <a href="#services--engineering-solutions-matrix"><img src="https://img.shields.io/badge/Role-Sistem_Mimar%C4%B1-0f172a?style=flat-square&labelColor=1e293b" alt="Systems Architect"/></a>
      ...
      <a href="https://github.com/LOUST-PRO/SnapPipe"><img src="https://img.shields.io/badge/Security-Zero--Trust_QUIC_Transport-1e293b?style=flat-square&labelColor=0f172a&logo=rust&logoColor=white" alt="Zero-Trust QUIC Transport"/></a>
      ...
      <a href="#-public-upstream-hardening--core-systems-invariants"><img src="https://img.shields.io/badge/Domain-%C3%87ekirdek_%26_Sistem_Ara%C5%9Ft%C4%B1rmas%C4%B1-0f172a?style=flat-square&labelColor=1e293b&logo=linux&logoColor=white" alt="Kernel & Systems Research"/></a>
      <img src="https://img.shields.io/badge/Mindset-Hayat_Boyu_%C3%96%C4%9Frenci-7c3aed?style=flat-square&labelColor=0f172a" alt="Lifelong Student"/>
      <img src="https://img.shields.io/badge/Teknik_Ustal%C4%B1k-Daha_eksiksiz_ve_sorumlu_bir_geli%C5%9Ftirici_olmak_i%C3%A7in_her_g%C3%BCn_%C3%A7al%C4%B1%C5%9F%C4%B1yorum-10b981?style=flat-square&labelColor=0f172a" alt="Teknik Ustalık: Daha eksiksiz ve sorumlu bir geliştirici olmak için her gün çalışıyorum"/>
      ...
      <a href="mailto:partnership@loust.pro?subject=Peer%20Collaboration"><img src="https://img.shields.io/badge/Connect-Meslekta%C5%9Flar_ve_heyecan_verici_projeler_ar%C4%B1yor-0284c7?style=flat-square&labelColor=0f172a" alt="Looking for peers & exciting projects"/></a>
    </td>
  </tr>
  <tr>
    <!-- Row 2: Research Specializations, Spec-Driven EDA & FOSS Governance -->
    <td align="left" valign="middle">
      <a href="https://gist.github.com/louzt/376f48c722d4a15d7e78f940818cbade"><img src="https://img.shields.io/badge/Research_Gist-Deterministik_Test_Demetleri-8b5cf6?style=flat-square&labelColor=0f172a&logo=github&logoColor=white" alt="Deterministic Harnesses Gist"/></a>
  ...
  <tr>
    ...
    <td align="left" valign="middle">
      ...
      <a href="https://opensource.org/"><img src="https://img.shields.io/badge/OSI-%C3%9Cyesi-3DA639?style=flat-square&logo=opensourceinitiative&logoColor=white" alt="OSI Member"/></a>
      ...
      <a href="https://crates.io/users/louzt"><img src="https://img.shields.io/badge/A%C3%A7%C4%B1k_Kaynak_Rust_Projelerimi_Ke%C5%9Ffedin-crates.io-E43717?style=flat-square&logo=rust&logoColor=white" alt="crates.io üzerindeki açık kaynak Rust projelerimi keşfedin"/></a>
    </td>
  </tr>
  <tr>
    ...
    <td align="left" valign="middle">
      ...
      <a href="https://www.linkedin.com/in/davidmirelesll/?locale=es_ES"><img src="https://img.shields.io/badge/Bana_yaz%C4%B1n_%26_Ba%C4%9Flant%C4%B1_kurun-LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white" alt="Bana yazın ve LinkedIn'de bağlantı kuralım"/></a>
  ...
  <tr>
    ...
    <td align="left" valign="middle">
      ...
      <a href="https://gist.github.com/louzt/3ba453b2876a4b105a9893b26541ffc3"><img src="https://img.shields.io/badge/Control_Planes-Zero--Slop_Deterministik_Test_Demetleri-7c3aed?style=flat-square&labelColor=0f172a&logo=github&logoColor=white" alt="Multi-Agent Control Planes Gist"/></a>
      <a href="https://gist.github.com/louzt/64715cb9c6ec6ffdd98c5712b8fb7bac"><img src="https://img.shields.io/badge/Security-RBAC_%26_%C3%87oklu_Kirac%C4%B1_%C4%B0zolasyonu-0f172a?style=flat-square&labelColor=1e293b" alt="RBAC & Multi-Tenant Isolation Case Study"/></a>
      <a href="https://github.com/LOUST-PRO/lzt-virtuoso-tools"><img src="https://img.shields.io/badge/Auditing-Virtuoso_%C3%9C%C3%A7l%C3%BCleri_%2f_SPARQL-2C3E50?style=flat-square&labelColor=0f172a" alt="Provenance Auditing Harness"/></a>
  ...
  <tr>
    ...
    <td align="left" valign="middle">
      <img src="https://img.shields.io/badge/Shipped-Open_Source_Systems-059669?style=flat-square&labelColor=0f172a&logo=git&logoColor=white" alt="Shipped Open Source Systems"/>
      <a href="https://github.com/LOUST-PRO/SnapPipe"><img src="https://img.shields.io/badge/SnapPipe-(Identity--Anchored_QUIC_Relay)-2C3E50?style=flat-square&labelColor=0f172a&logo=rust&logoColor=white" alt="SnapPipe: Identity-Anchored QUIC Relay"/></a>
      <a href="https://github.com/LOUST-PRO/paperforge"><img src="https://img.shields.io/badge/PaperForge-(GTK4_Async_Engine_Frontend)-8B5CF6?style=flat-square&labelColor=0f172a&logo=rust&logoColor=white" alt="PaperForge: GTK4 Linux Wallpaper Engine Frontend"/></a>
      <a href="https://github.com/LOUST-PRO/NetBoozt_InternetUpgrade"><img src="https://img.shields.io/badge/NetBoozt-(Sub--10ms_ISP_TCP_Tuning)-F59E0B?style=flat-square&labelColor=0f172a&logo=tauri&logoColor=black" alt="NetBoozt: ISP Intelligence & TCP Tuning"/></a>
      <a href="https://github.com/LOUST-PRO/LinkMarks"><img src="https://img.shields.io/badge/LinkMarks-(Fast_CRDT_Automerge_Sync)-10B981?style=flat-square&labelColor=0f172a&logo=rust&logoColor=white" alt="LinkMarks: Fast Local-First CRDT Bookmarks"/></a>
      <a href="https://github.com/LOUST-PRO/TaxonRouter"><img src="https://img.shields.io/badge/TaxonRouter-(GitHub_Projects_v2_MCP)-00ADD8?style=flat-square&labelColor=0f172a&logo=go&logoColor=white" alt="TaxonRouter: GitHub Projects v2 Automation & MCP Server"/></a>
      <a href="https://github.com/LOUST-PRO/spec-snapshot-scraper"><img src="https://img.shields.io/badge/spec--snapshot--scraper-(Zero--Drift_Markdown_Archiver)-10B981?style=flat-square&labelColor=0f172a&logo=go&logoColor=white" alt="spec-snapshot-scraper: Deterministic Spec Archiver"/></a>
      <a href="https://github.com/LOUST-PRO/lzt-virtuoso-tools"><img src="https://img.shields.io/badge/lzt--virtuoso--tools-(SPARQL_TriG_RDF_Provenance)-2C3E50?style=flat-square&labelColor=0f172a" alt="lzt-virtuoso-tools: SPARQL TriG Knowledge Engine"/></a>
      <a href="https://crates.io/crates/llmmempipe"><img src="https://img.shields.io/badge/llmmempipe-(Zero--Alloc_Shared--Memory_IPC)-000000?style=flat-square&labelColor=0f172a&logo=rust&logoColor=e43717" alt="llmmempipe: Zero-Alloc Shared-Memory Pipe"/></a>
      <a href="https://github.com/LOUST-PRO/outlook-mcp-suite"><img src="https://img.shields.io/badge/outlook--mcp--suite-(OAuth2_Full--Stack_Graph_MCP)-0078D4?style=flat-square&labelColor=0f172a&logo=microsoftoutlook&logoColor=white" alt="outlook-mcp-suite: Full-Stack Graph & Mail MCP"/></a>
      <a href="https://github.com/LOUST-PRO/vivaldi-workspace-mcp"><img src="https://img.shields.io/badge/vivaldi--workspace--mcp-(Real--Time_IPC_Hook)-EF3939?style=flat-square&labelColor=0f172a&logo=vivaldi&logoColor=white" alt="vivaldi-workspace-mcp: Tab & Workspace Automation MCP"/></a>
      <a href="https://github.com/LOUST-PRO/ical-to-caldav"><img src="https://img.shields.io/badge/ical--to--caldav-(Conflict--Free_Calendar_Sync)-4285F4?style=flat-square&labelColor=0f172a&logo=googlecalendar&logoColor=white" alt="ical-to-caldav: Bidirectional Calendar Sync"/></a>
      <a href="https://github.com/LOUST-PRO/clipboard-wayland-x11-sync"><img src="https://img.shields.io/badge/clipboard--sync-(Zero--Fork_Wayland%E2%86%94X11_Daemon)-00ADD8?style=flat-square&labelColor=0f172a&logo=linux&logoColor=white" alt="clipboard-wayland-x11-sync: Wayland↔X11 Clipboard Daemon"/></a>
      <a href="https://github.com/LOUST-PRO/lzt-broker-stall-reaper"><img src="https://img.shields.io/badge/lzt--broker--stall--reaper-(Auto_SIGKILL_TCP_Watchdog)-00ADD8?style=flat-square&labelColor=0f172a&logo=linux&logoColor=white" alt="lzt-broker-stall-reaper: CI/CD Runner TCP Watchdog"/></a>
      <a href="https://github.com/LOUST-PRO/unattended-upgrade-stuck-kill"><img src="https://img.shields.io/badge/unattended--upgrade--kill-(DPKG_Lock_Recovery)-E95420?style=flat-square&labelColor=0f172a&logo=ubuntu&logoColor=white" alt="unattended-upgrade-stuck-kill: Apt Lock Watchdog Reaper"/></a>
      <a href="https://github.com/LOUST-PRO/lzt-algorithms-rs"><img src="https://img.shields.io/badge/lzt--algorithms--rs-(SIMD--Accelerated_Zero--Alloc)-000000?style=flat-square&labelColor=0f172a&logo=rust&logoColor=white" alt="lzt-algorithms-rs: Zero-Alloc Algorithms Crate"/></a>
      <a href="https://crates.io/crates/ttfx-rs"><img src="https://img.shields.io/badge/ttfx--rs-(Zero--Heap_ANSI_Shaders)-000000?style=flat-square&labelColor=0f172a&logo=rust&logoColor=e43717" alt="ttfx-rs: Terminal Text Effects Engine on Crates.io"/></a>
      <img src="https://img.shields.io/badge/%7C-1e293b?style=flat-square" alt="|"/>
      <img src="https://img.shields.io/badge/Contributed_to-Upstream_FOSS-1e293b?style=flat-square&labelColor=0f172a&logo=github&logoColor=white" alt="Contributed to Upstream FOSS"/>
      <a href="#-public-upstream-hardening--core-systems-invariants"><img src="https://img.shields.io/badge/Deep_Dive-%E2%86%93_Audit_Evidence_Below-2563EB?style=flat-square&labelColor=0f172a" alt="Deep Dive: ↓ Audit Evidence Below"/></a>
      <a href="https://h4kken.loust.pro"><img src="https://img.shields.io/badge/H4KKEN-(120_FPS_Rollback_WebGPU)-AC162C?style=flat-square&labelColor=0f172a&logo=babylondotjs&logoColor=white" alt="H4KKEN: Rollback WebGPU Fighter"/></a>
      <a href="https://github.com/EpicGames/zen/commit/14cc6ca40f0ec33b026ffe4cae85b8b04d4ade8f"><img src="https://img.shields.io/badge/Epic_Games_Zen-(-100%25_Redundant_UE5_DDC_I%2FO)-000000?style=flat-square&labelColor=0f172a&logo=unrealengine&logoColor=white" alt="Epic Games Zen Storage Server Commit"/></a>
      <a href="https://github.com/ValveSoftware/Fossilize/pull/305"><img src="https://img.shields.io/badge/Valve_Fossilize-(Zero_Zombie_Leaks_%C2%B7_PR_SET_PDEATHSIG)-171A21?style=flat-square&labelColor=0f172a&logo=steam&logoColor=white" alt="Valve Fossilize PR #305"/></a>
      <a href="https://github.com/louzt/pipewire/commit/2f747a7"><img src="https://img.shields.io/badge/PipeWire-(100%25_Deadlock_Elimination_%C2%B7_5s_SPA)-E63946?style=flat-square&labelColor=0f172a&logo=linux&logoColor=white" alt="PipeWire Commit"/></a>
      <a href="https://github.com/Almamu/linux-wallpaperengine"><img src="https://img.shields.io/badge/Linux_Wallpaper_Engine-(KWin%2fHyprland_Crash_Recovery)-171A21?style=flat-square&labelColor=0f172a&logo=linux&logoColor=white" alt="Linux Wallpaper Engine (LWE)"/></a>
      <a href="https://github.com/anufrievroman/waypaper/pull/286"><img src="https://img.shields.io/badge/Waypaper-(Zero_Artifact_HiDPI_Upscaling)-00ADD8?style=flat-square&labelColor=0f172a&logo=linux&logoColor=white" alt="Waypaper PR #286"/></a>
      <a href="https://github.com/AvengeMedia/DankMaterialShell/pull/2972"><img src="https://img.shields.io/badge/DankMaterialShell-(O(1)_Dynamic_Registry_Lookup)-6366F1?style=flat-square&labelColor=0f172a&logo=gnome&logoColor=white" alt="DankMaterialShell PR #2972"/></a>
      <a href="https://gist.github.com/louzt/7bdf370a28126718e7e7b69d53b0ae86"><img src="https://img.shields.io/badge/NGINX-(4.9k_req%2fs_ApacheBench_Sanitized)-009639?style=flat-square&labelColor=0f172a&logo=nginx&logoColor=white" alt="NGINX CRLF Gist"/></a>
      <a href="https://github.com/nektos/act"><img src="https://img.shields.io/badge/nektos%2Fact-(Zero_Race_Cache_Concurrency)-2088FF?style=flat-square&labelColor=0f172a&logo=githubactions&logoColor=white" alt="nektos/act Runner Concurrency Hardening"/></a>
      <a href="https://github.com/appwrite/mcp"><img src="https://img.shields.io/badge/Appwrite_MCP-(Strict_MCP_Spec_Discovery)-FD366E?style=flat-square&labelColor=0f172a&logo=appwrite&logoColor=white" alt="Appwrite MCP ToolAnnotations & Discovery"/></a>
      <a href="https://github.com/serpapi/serpapi-mcp/pull/48"><img src="https://img.shields.io/badge/SerpApi_MCP-(RFC_6570_Lazy_Expansion_%C2%B7_PR_%2348)-4A90E2?style=flat-square&labelColor=0f172a&logo=google&logoColor=white" alt="SerpApi MCP PR #48"/></a>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="middle">
      ...
      <img src="https://img.shields.io/badge/Kripto_%C3%96demeler_(BTC%2fSOL)-121D33?style=flat-square&logo=solana&logoColor=white" alt="Crypto Payments"/>
      <img src="https://img.shields.io/badge/%C3%96zel_REST_%26_GraphQL_APIs-00A1E0?style=flat-square" alt="Custom REST & GraphQL APIs"/>
      <img src="https://img.shields.io/badge/Sunucu_Taraf%C4%B1_%C4%B0zleme-00A1E0?style=flat-square&logo=salesforce&logoColor=white" alt="Server-Side Tracking"/>
...
- **Research collaborations** — formal proofs, deterministic systems, transport-layer hardening, sovereign AI infra. Best fit: university labs, independent PhD-track researchers, and private R&D teams working in applied-probability / IR / agent frameworks. Reach out at [arastirma@loust.pro](mailto:arastirma@loust.pro) with a 1-paragraph abstract and a concrete artifact (gist, paper draft, benchmark).
...
<p align="center"><sub>Whether designing greenfield AWS architectures or auditing and benchmarking existing production infrastructure, I replace bloated cloud defaults with deterministic, cost-avoidant systems engineered from first principles</sub></p>

| Enterprise Cloud / AWS Target | Typical Industry Baseline (Default Cloud Dev) | What I Architect &amp; Deploy (Hardened Substrates &amp; Cloud) | Measured Production Lift &amp; ROI |
| :--- | :--- | :--- | :--- |
| **AWS API Gateway / Lambda Serverless** | Heavy cold starts (300–800ms), unvalidated runtime JSON payloads, bloated Node/Python layers, unbudgeted API throttling. | **Architect** zero-allocation Go/Rust edge proxies, compile-time OpenAPI 3.0 / JSON Schema contracts, non-blocking epoll loops, Model Context Protocol (MCP) stdio servers. | **Sub-15ms p95 latency**, 90%+ cold-start elimination, zero payload injection vulnerabilities, and bounded memory footprints. |
| **AWS EKS / ECS / Fargate Containers** | Bloated multi-GB images, unconstrained pod CPU/RAM throttling, idle billing during zero-traffic windows, manual console drift. | **Orchestrate** declarative GitOps YAML/Helm manifests, enforce `cgroup v2` resource boundaries, k3s standby auto-scaling to 0 replicas, multi-arch CI/CD GitHub Actions. | **100% idle resource reclaim (~8 GB RSS freed per idle tenant)**, &lt;15s warm-start container spin-up, zero OOM kill cascade risks. |
| **AWS CloudWatch, X-Ray &amp; Datadog** | Super-linear log regex backtracking (Loki/Vector CPU churn), unbuffered log writes blocking worker threads, runaway ingest costs. | **Instrument** native O(1) `--log-json` structured sinks, OpenTelemetry (OTel) traces, Linux Pressure Stall Information (PSI), and `tcp_diag` kernel watchdogs. | **Zero main-thread blocking regressions**, 70% reduction in telemetry bloat, sub-second root-cause diagnosis without manual log scraping. |
| **AWS DynamoDB Streams, SQS &amp; EventBridge** | Retry amplification storms, non-idempotent event replays, deadlocks on webhook failures, costly polling loops. | **Engineer** atomic Redis 7 Lua EVAL queues, AsyncAPI specs, JSONL append-only streaming protocols, idempotent state machines &amp; DLQ retry topologies. | **Zero data-loss guarantee**, sub-second webhook ingestion, 100% idempotent replay recovery during downstream vendor outages. |
| **AWS S3, CloudFront CDN &amp; Global Edge** | Uncached dynamic origin saturation, manual click-ops, cold cache misses, high monthly egress bandwidth fees. | **Deploy** Infrastructure as Code (IaC) via Terraform / OpenTofu, hardened NGINX edge caching, NVMe volume mounts, Automated Persisted Queries (APQ). | **90.9% APQ cache hit rate**, +125% origin throughput lift at **$0/mo incremental cloud overhead**, 100% reproducible IaC state. |
